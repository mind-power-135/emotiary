...
<div class="container">
	<div class="form-group">
      ...
      <br/>
      <input class="mail-check-input" placeholder="인증번호 6자리를 입력하고 엔터를 눌러주세요!" disabled="disabled" maxlength="6">
	  <span id="mail-check-warn"></span>
	  <br/>
      <label for="firstPw">PW</label>
      <input type="text" id="firstPw" name="firstPw" placeholder="암호를 입력하세요">
      <br/>
